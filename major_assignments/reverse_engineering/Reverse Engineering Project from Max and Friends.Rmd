...
public_enrollment <- read_csv("~/Desktop/JOUR-472-772-Assignments-CASSETT 2/major_assignments/reverse_engineering/data/public-enrollment-by-grade.csv") |> clean_names()
private_enrollment <- read_csv("~/Desktop/JOUR-472-772-Assignments-CASSETT 2/major_assignments/reverse_engineering/data/private-enrollment-by-grade.csv") |> clean_names()
population_by_age <- read_csv("~/Desktop/JOUR-472-772-Assignments-CASSETT 2/major_assignments/reverse_engineering/data/population-by-age.csv") |> clean_names()
