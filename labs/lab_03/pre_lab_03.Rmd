...
```{r}
zip_totals <- cleaned_md_grants_loans |>
...
So the top answer was Baltimore county and there was no surprise there. I'd only assume that Marylands biggest city would receive the most money especially because its the one with the biggest need of a clean up. Baltimore is a major part of the economy of Maryland and giving it the most money is investing in a realistic guess as to where people go when they visit the state.
