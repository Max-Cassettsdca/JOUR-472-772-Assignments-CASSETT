...
```{r, echo=FALSE}
knitr::include_graphics(rep("~/Desktop/JOUR-472-772-Assignments-CASSETT/pre_labs/pre_lab_11/images/rvest1.png"))
```
...
I don't think that there's anything I would add to these releases. Maybe who the author is or what category of news it is.
