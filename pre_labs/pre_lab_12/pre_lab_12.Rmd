...
looks like some sort of medical information.
...
I dont understand what the function is doing to the words.
...
this is trippy and interesting
...
This seems like a more relevant list of words used in the data than the list of stop words we had before.I like that we have the percent of them coming up up.
...
more very relevant words and phrases.
...
at this point im getting a little lost but i do get the principle of what we're doing.
...
this is just a shortening of a previuos list.
...
THis part is confunsing me. How can we understand sentiments? how does the computer understand sentiments?
