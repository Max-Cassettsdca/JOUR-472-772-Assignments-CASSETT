...
```{r}
question <- axolotr::ask(
  prompt = "can you explain all the basic funcitons of R, like stuff I would learn in the class Jour472 at the univeristy of maryland school of journalism. Explain it to me like you were explaining the portugeuse language to an american",
  model = "llama-3.1-8b-instant"
)
question
